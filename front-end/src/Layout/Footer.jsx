    ...
    <div>
      ...
      <div className="  bg-[#000c] copyright border-t-[1px] py-3 px-10 border-dashed border-white">
        <div className="flex sm:flex-row flex-col justify-between items-center">
          ...
          <div className="flex items-center"><Link className="sm:text-right text-center" target="blank" to="https://www.linkedin.com/in/mohamed-hamza-trabelsi"><img className="mr-2" src={process.env.PUBLIC_URL + '/icones/linkedin.svg'} alt="linkedin" /></Link>
