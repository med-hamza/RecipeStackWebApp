...
const Footer = () => {
  return (
    <div>
      <div className='text-center p-16 bg-[#000c]'>
        <div>
          <div className='p-4'>
      ...
      <div className="  bg-[#000c] copyright border-t-[1px] py-3 px-10 border-dashed border-white">
        <div className="flex sm:flex-row flex-col justify-between items-center">
          ...
          <div className="flex items-center"><Link className="sm:text-right text-center" target="blank" to="https://www.linkedin.com/in/mohamed-hamza-trabelsi"><img className="mr-2" src={'/icones/linkedin.svg'} alt="linkedin" /></Link>
            <Link to="https://www.instagram.com/t_m_hamza/" target="blank"><img src={'/icones/instagram.svg'} alt="instgram" /></Link>
          </div></div></div>
    </div>
  )
}
